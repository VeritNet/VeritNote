...
# 4. 删除 processed_assets 中的所有 .ts 文件 (保留纯净的JS用于后续处理)
...
message(STATUS "[TS Pipeline][Execute] ${NODE_CMD} \"${TS_CLOSURE_TOOL_DIR}/cli.js\" generate-externs --project \"${SRC_WEB_ASSETS_DIR}/components/tsconfig.json\" --out \"${EXTERNS_OUT}\"")
execute_process(
